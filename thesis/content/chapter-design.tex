...
\begin{enumerate}[label=\alph*) ]
  \item Der Server verwaltet einen eigenen Index, auf dem Filter-Anfragen effizient ausgewertet werden können und das Ergebnis ohne große Kosten als RDF ausgegeben werden können, ähnlich dem Wikidata Query Service.
