\begin{tikzpicture}[
  ...
  \begin{scope}[uncover=<2->]
    ...
    \node[nw] (typ) at (8, 0) { wikibase:Statement };
  ...
  \begin{scope}[uncover=<3->]
    \node[nw] (vn1) at (7, 1.5) { wdv:aaaaaaaa };
    \node[nw] (v1) at (2, 3) {\verb|"1959-01-01T00:00:00Z"^^xds:dateTime| };
    \node[nw] (vn2) at (7, -1.5) { wdv:bbbbbbbb };
    \node[nw] (v2) at (2, -3) {\verb|"1970-01-01T00:00:00Z"^^xsd:dateTime| };

    \draw[e] (s.south) to node[below, sloped, outer sep=2pt] {pq:P582} (v2.north);
    ...
    \draw[e] (s) to node [sloped, above, outer sep=1pt] {pq:P580} (v1.south);
  \end{scope}
